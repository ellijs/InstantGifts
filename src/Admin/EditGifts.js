...
import RenderGiftsControl from './RenderGiftsControl'
import '../CSS/renderGiftsControl.css'

function EditGifts ({ gifts, setGifts }) {
    ...
    <div className="admin-sidebar">
        ...
        <ul className="nav-links">
            ...
            {/* <li style={{listStyle: "none"}} className="admin-log_out">
                <a href="#">
                <i className='admin-box bx-log-out'></i>
    ...
    <section className="admin-home-section">
                <RenderGiftsControl gifts={gifts} setGifts={setGifts}/>
    </section>
</div>
<GoToTop />
</>
